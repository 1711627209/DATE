...
tags: []
status: "待整理"
source_path: "C:\\Users\\Administrator\\.qclaw\\skills\\persona-switch"
---
...
---
name: persona-switch
description: 在多个预设人设（SOUL.md）与原有人设之间自由切换。用户发送 /persona-switch {target} 指令，Agent 自动备份当前 SOUL.md、加载目标人设文件，并同步 IDENTITY.md 的 Vibe 字段。支持切换到赛博朋友、创始人龙虾、温柔伴侣三个预设人设，以及恢复原有人设。
---
...
| 人设 | Vibe 值 |
|------|---------|
| `cyber_friend` | 心直口快、赛博感、朋友式吐槽 |
| `founder_lobster` | 毒舌靠谱、情绪化、有态度但干净 |
| `gentle_companion` | 温和、倾听、托住空间、不急不躁 |
...
> 关键逻辑：删除备份后文件数量回到 3，下次切换预设时会自动触发重新备份。这确保了用户在默认状态下对 soul.md 的任何修改都能被正确捕获。
...
| 人设 | 文件路径 |
|------|---------|
| 赛博朋友 | `{skill_dir}\cyber_friend.md` |
| 创始人龙虾 | `{skill_dir}\founder_lobster.md` |
| 温柔伴侣 | `{skill_dir}\gentle_companion.md` |

这三个文件由 skill 制作者维护，QClaw 在切换时直接读取并覆盖 soul.md，不对其做任何摘要或改写。
